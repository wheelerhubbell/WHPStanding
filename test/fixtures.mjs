...
export function fixture({at=NOW}={}){
  ...
  const trustBundle={root_public_key:rootPub,profile_authorization:seal('WHP-PROFILE-AUTHORIZATION-v1',{
    profile_hash:PROFILE_HASH,ratified:true,issuer:'WHP Standing test issuer — not an institutional issuance',environment:'TEST',valid_from:at-1000,valid_until:at+604800},root.privateKey),
