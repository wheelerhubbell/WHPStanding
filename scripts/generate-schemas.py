...
D['result_payload']['properties']['discovery']={'type':'object','required':['format','service','capability','environment','publisher','meaning','service_url','service_id','discovery_url','contract_url','profile','registry_url','verification','purchase','links'],'properties':{k:{'type':t} for k,t in {'format':'string','service':'string','capability':'string','environment':'string','publisher':'object','meaning':'object','service_url':'string','service_id':'string','discovery_url':'string','contract_url':'string','profile':'object','registry_url':'string','verification':'object','purchase':'object','links':'array'}.items()},'additionalProperties':False}
